...
export class AnnualSubscriptionPlanService {
  public resourceUrl = SERVER_API_URL + 'company-service/api/annual-subscription-plans';
  ...
  create(annualSubscriptionPlan: IAnnualSubscriptionPlan): Observable<EntityResponseType> {
    ...
    return this.http
      .post<IAnnualSubscriptionPlan>(this.resourceUrl, copy, { observe: 'response' })
