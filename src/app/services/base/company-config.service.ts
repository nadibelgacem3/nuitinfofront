...
export class CompanyConfigService {
    ...
    //     return this.http.get(`${this.resourceUrl_2}/checkFree/${id}`, {observe: 'response'});
    // }
    checkDemo(id: number) {
        return this.http.get(`${this.resourceUrl_2}/checkFree/${id}`, {observe: 'response'});
    }
    ...
    query(req?: any): Observable<EntityArrayResponseType> {
        ...
        return this.http.get<ICompanyConfig[]>(this.resourceUrl, {params: options, observe: 'response'});
    }
