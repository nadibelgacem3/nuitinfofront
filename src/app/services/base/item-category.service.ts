...
export class ItemCategoryService {
    public resourceUrl = SERVER_API_URL + 'sauveteurs-micro/api/publication-categories';
    ...
    create(itemCategory: any): Observable<EntityResponseType> {
        return this.http.post<IItemCategory>(this.resourceUrl, itemCategory, {observe: 'response'}).pipe(
            catchError(e => {
                Swal.fire({
                    icon: 'info',
                    title: 'Network Error',
