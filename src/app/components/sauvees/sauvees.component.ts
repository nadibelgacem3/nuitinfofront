...
@Component({
  selector: 'app-sauvees',
  templateUrl: './sauvees.component.html',
  styleUrls: ['./sauvees.component.scss']
})
export class SauveesComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private fb: FormBuilder, protected boatsService: SauveesService, private pipeTranslate: TranslationMyWayService, protected dataUtils: JhiDataUtils, protected elementRef: ElementRef, protected eventManager: JhiEventManager) {
  ...
  saveCategory() {
    ...
    formData.append('sauvee', JSON.stringify(itemCategory));
